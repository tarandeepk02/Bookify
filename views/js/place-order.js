...
document.addEventListener("DOMContentLoaded", () => {
    renderOrderItems(); // Render the cart when the page loads
});
                            ...
                            <div class="card-body p-4">
                                <div class="row">
                                    <div class="col-lg-4 col-xl-3 ms-auto">
                                        ...
                                        <button id= "checkoutButton" type="button"  data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block btn-lg">
